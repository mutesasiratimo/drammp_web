...
class AddNonIndividualFishRevenueStreamPage extends StatefulWidget {
  final String category;
  final String ownerType;
  final String categoryId;
  final String sector;
  final String sectorId;
  const AddNonIndividualFishRevenueStreamPage({
    super.key,
  ...
  @override
  State<AddNonIndividualFishRevenueStreamPage> createState() =>
      _AddNonIndividualFishRevenueStreamPageState();
}

class _AddNonIndividualFishRevenueStreamPageState
    extends Base<AddNonIndividualFishRevenueStreamPage> {
