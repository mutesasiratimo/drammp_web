                                          ...
                                          onSort: (columnIndex, _) {
                                            setState(() {
                                              ...
                                              if (_isAscending == true) {
                                                ...
                                                // sort the product list in Ascending, order by Price
                                                _fares.sort((userA, userB) =>
                                                    userB.basefare.compareTo(
                                                        userA.basefare));
                                              } else {
                                                _isAscending = true;
                                                // sort the product list in Descending, order by Price
                                                _fares.sort((userA, userB) =>
                                                    userA.basefare.compareTo(
                                                        userB.basefare));
                                              }
                                            });
                                          },
                                          ...
                                          onSort: (columnIndex, _) {
                                            setState(() {
                                              ...
                                              if (_isAscending == true) {
                                                ...
                                                // sort the product list in Ascending, order by Price
                                                _fares.sort((userA, userB) =>
                                                    userB.firstkmrate.compareTo(
                                                        userA.firstkmrate));
                                              } else {
                                                _isAscending = true;
                                                // sort the product list in Descending, order by Price
                                                _fares.sort((userA, userB) =>
                                                    userA.firstkmrate.compareTo(
                                                        userB.firstkmrate));
                                              }
                                            });
                                          },
                                          ...
                                          onSort: (columnIndex, _) {
                                            setState(() {
                                              ...
                                              if (_isAscending == true) {
                                                ...
                                                // sort the product list in Ascending, order by Price
                                                _fares.sort((userA, userB) =>
                                                    userB.nextkmrate.compareTo(
                                                        userA.nextkmrate));
                                              } else {
                                                _isAscending = true;
                                                // sort the product list in Descending, order by Price
                                                _fares.sort((userA, userB) =>
                                                    userA.nextkmrate.compareTo(
                                                        userB.nextkmrate));
                                              }
                                            });
                                          },
                                            ...
                                            setState(() {
                                              ...
                                              if (_isAscending == true) {
                                                ...
                                                _tarrifs.sort((userA, userB) =>
                                                    userB.purpose.compareTo(
                                                        userA.purpose));
                                              } else {
                                                _isAscending = true;
                                                // sort the product list in Descending, order by Price
                                                _tarrifs.sort((userA, userB) =>
                                                    userA.purpose.compareTo(
                                                        userB.purpose));
                                              }
                                            });
                                          },
                                          ...
                                          onSort: (columnIndex, _) {
                                            setState(() {
                                              ...
                                              if (_isAscending == true) {
                                                ...
                                                // sort the product list in Ascending, order by Price
                                                _tarrifs.sort((userA, userB) =>
                                                    userB.frequency.compareTo(
                                                        userA.frequency));
                                              } else {
                                                _isAscending = true;
                                                // sort the product list in Descending, order by Price
                                                _tarrifs.sort((userA, userB) =>
                                                    userA.frequency.compareTo(
                                                        userB.frequency));
                                              }
                                            });
                                          },
