...
class BarChartPageMonthly extends StatefulWidget {
  BarChartPageMonthly({super.key});
  final Color leftBarColor = Colors.yellow;
  final Color rightBarColor = Colors.green.shade300;
  final Color avgColor = Colors.white;
  State<StatefulWidget> createState() => BarChartPageMonthlyState();
}

class BarChartPageMonthlyState extends State<BarChartPageMonthly> {
  ...
  void initState() {
    super.initState();
    final barGroup1 = makeGroupData(0, 6.2, 0);
